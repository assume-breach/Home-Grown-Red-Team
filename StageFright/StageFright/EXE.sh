...
echo ""
echo -e "$BOLD_BLUE 1.$BOLD_WHITE SMB Stager"
echo -e "$BOLD_BLUE 2.$BOLD_WHITE TCP Stager"
echo -e "$BOLD_BLUE 3.$BOLD_WHITE HTTP Stager"
echo ""
echo -n -e "$BOLD_WHITE > "
read CHOICE
clear
